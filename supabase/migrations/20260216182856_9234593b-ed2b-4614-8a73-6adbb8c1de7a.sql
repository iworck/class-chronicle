...
-- Add approval criteria columns to subjects table
ALTER TABLE public.subjects
  ADD COLUMN min_grade NUMERIC(5,2) NOT NULL DEFAULT 7.0,
  ADD COLUMN min_attendance_pct NUMERIC(5,2) NOT NULL DEFAULT 75.0;

-- Update the trigger function to use per-subject criteria
